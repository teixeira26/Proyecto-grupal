    ...
    <BrowserRouter>
      <div className="App">
        <Routes>
          ...
          <Route
            path="/home"
            element={isAuthenticated && !isLoading ? <Home /> : <Loading />}
          />
          ...
          <Route
            path="/agregarusuario"
            element={isAuthenticated && !isLoading ? <AddOwner /> : <Loading />}
          />
          <Route
            path="/agregarmascota"
            element={isAuthenticated && !isLoading ? <AddPet /> : <Loading />}
          />
          <Route
            path="/tipo-usuario"
          ...
          <Route
            path="/profile"
            element={isAuthenticated && !isLoading ? <Profile /> : <Loading />}
          />
          <Route
            path="/infoprovider"
            element={
          ...
          <Route
            ...
            element={isAuthenticated && !isLoading ? <Chat /> : <Loading />}
          />
          <Route
            path="/favorites"
            element={
          ...
          <Route
            path="/paseo"
            element={isAuthenticated && !isLoading ? <Walk /> : <Loading />}
          />
          <Route
            path="/hospedaje"
            element={isAuthenticated && !isLoading ? <Lodging /> : <Loading />}
          />
