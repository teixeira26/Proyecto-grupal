...
export default function ProductsList() {
  ...
  function ban(useremail) {
    Swal.fire({
      title:
        "¿Estas seguro que querés inactivar al usuario? Esto le impedirá acceder a la plataforma y a toda la información relacionada con la misma.",
      showDenyButton: true,
  ...
  function unBan(useremail) {
    Swal.fire({
      title:
        "¿Estás seguro que querés habilitar al usuario? Esto le dará acceso a la plataforma y a toda la información relacionada con la misma.",
      showDenyButton: true,
      denyButtonText: `Descartar`,
