    ...
    return (
        <main>
            ...
            <div className={styleContainer.container}>
                ...
                <p>Te dejamos este espacio para que puedas escribirnos acerca de cualquier asunto relacionado a <strong>yumPaw</strong>. ¡Queremos seguir mejorando tu experiencia!</p>
                <div>
                    <Form>
